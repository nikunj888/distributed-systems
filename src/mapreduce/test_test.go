...
//// Make chicken input file
//func makeChickenInput() string {
//	name := "chicken.txt"
//	file, err := os.Create(name)
//	if err != nil {
//		log.Fatal("mkInput: ", err)
...
//	return name
//}
//func setupChicken() *MapReduce {
//	file := makeChickenInput()
//	master := port("master")
//	mr := MakeMapReduce(4, 2, file, master)
//	return mr
//}
//func TestChicken(t *testing.T) {
//	fmt.Printf("Test: Chicken mapreduce ...\n")
//	mr := setupChicken()
//	for i := 0; i < 2; i++ {
